...
public class GetTagByTitleHandler : IRequestHandler<GetTagByTitleQuery, Result<TagDTO>>
{
    ...
    {
        var tag = await _repositoryWrapper.TagRepository.GetFirstOrDefaultAsync(t => t.Title == request.Title);
        ...
        var errorMsg = Messages.Error_TagWithTitleNotFound.Format(request.Title);
